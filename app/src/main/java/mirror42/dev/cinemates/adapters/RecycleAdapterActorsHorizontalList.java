...
public class RecycleAdapterActorsHorizontalList extends RecyclerView.Adapter<ActorCardsHolder>{
    ...
    public RecycleAdapterActorsHorizontalList(ArrayList<Person> peopleList, Context context) {
