...
public class RecycleAdapterExplorePage extends RecyclerView.Adapter<ExplorePageViewHolder>  {
    ...
    public RecycleAdapterExplorePage(ArrayList<Movie> moviesList, Context context) {
