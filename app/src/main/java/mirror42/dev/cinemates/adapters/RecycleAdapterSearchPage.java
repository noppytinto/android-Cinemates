...
public class RecycleAdapterSearchPage extends RecyclerView.Adapter<SearchRecordViewHolder> {
    ...
    public RecycleAdapterSearchPage(ArrayList<Movie> moviesList, Context context) {
