...
public class RecyclerAdapterExploreUpcoming extends RecyclerView.Adapter<RecyclerAdapterExploreUpcoming.MovieCardViewHolder>  {
    ...
    public RecyclerAdapterExploreUpcoming(ArrayList<Movie> moviesList, Context context) {
