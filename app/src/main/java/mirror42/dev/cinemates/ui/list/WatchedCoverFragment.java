...
public class WatchedCoverFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(viewId == R.id.cardView_listCover) {
            if(list!=null && list.getMovies() != null && list.getMovies().size()>0) {
                ...
                NavHostFragment.findNavController(WatchedCoverFragment.this).navigate(listFragment);
            }
