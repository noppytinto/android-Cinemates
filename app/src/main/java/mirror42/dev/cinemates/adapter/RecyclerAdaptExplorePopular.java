...
public class RecyclerAdaptExplorePopular extends RecyclerView.Adapter<RecyclerAdaptExplorePopular.MovieCardViewHolder>  {
    ...
    public RecyclerAdaptExplorePopular(ArrayList<Movie> moviesList, Context context) {
