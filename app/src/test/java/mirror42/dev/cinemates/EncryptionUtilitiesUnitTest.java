...
public class EncryptionUtilitiesUnitTest {
    ...
    @Test
    public void SHA256value_isValid_char() {
        String testValue = "a";
    ...
    @Test
    public void SHA256value_isValid_alphaString() {
    ...
    @Test
    public void SHA256value_isValid_emptyString() {
        String testValue = "";
    ...
    @Test
    public void SHA256value_isValid_nullString() {
    ...
    @Test
    public void SHA256value_isValid_onlyNumbers() {
    ...
    @Test
    public void SHA256value_isValid_alphaNum() {
    ...
    @Test
    public void SHA256value_isValid_onlySymbols() {
        String testValue = "?!@#$";
    ...
    @Test
    public void SHA256value_isValid_mixed() {
